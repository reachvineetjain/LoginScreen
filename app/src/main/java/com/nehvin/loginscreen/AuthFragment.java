...
public abstract class AuthFragment extends Fragment {
    ...
    protected com.nehvin.loginscreen.VerticalTextView caption;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        caption.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i(TAG, "unfold: " + caption.getText());
                if(caption.getText().equals(getString(R.string.sign_up_label))){
                    Log.i(TAG, "onClick: Need to sign up");
                    authenticate();
                }
                else{
                    if(caption.getText().equals(getString(R.string.log_in_label))){
                        Log.i(TAG, "onClick: Need to login up");
                        authenticate();
                    }
                }
